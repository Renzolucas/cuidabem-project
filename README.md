CuidaBEM - Gestão de Medicamentos
...
Banco de Dados & Auth: Supabase (Autenticação por e-mail e armazenamento seguro)

Design: Figma (Prototipagem de UI/UX focada em acessibilidade)
...
Sistema de Alarme: Lógica implementada para disparar alertas baseados nos horários cadastrados pelo usuário.

Design Inclusivo: Prototipagem feita no Figma pensando na facilidade de uso para pessoas com dificuldades motoras ou visuais.

LINK DE IMAGENS E VIDEO DO PROJETO FUNCIONANDO:https://drive.google.com/drive/folders/1MhjUEia_yKjq5IHm02dzG8gZTWN0Xqnh
